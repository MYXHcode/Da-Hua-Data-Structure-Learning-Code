...
int main()
{
    ...
    srand(time(0));
    int Max=10000;
    int d_big_data_sorting[10000];
    int i_big_data_sorting;
    SqList l12;

    for(i_big_data_sorting =0; i_big_data_sorting <Max; i_big_data_sorting++)
        d_big_data_sorting[i_big_data_sorting]=rand()%Max+1;

    for(i_big_data_sorting =0; i_big_data_sorting <Max; i_big_data_sorting++)
        l0.r[i_big_data_sorting+1]= d_big_data_sorting[i_big_data_sorting];
